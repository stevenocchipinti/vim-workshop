...
type MessageFromWorker = MessageFromWorkerWithoutTimestamp & {
  timestamp?: number
}
...
export class InputHandler {
  ...
  userOnKey?: (event: KeyboardEvent) => void
  ...
  onVimExit() {
    this.elem.removeEventListener("keydown", this.onKeydown, { capture: true })
...
export class ScreenCanvas implements DrawEventHandler, ScreenDrawer {
  ...
  constructor(
    ...
    this.input = new InputHandler(this.worker, input, onKey)
